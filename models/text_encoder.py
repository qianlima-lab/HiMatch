...
class GRU(nn.Module):
    ...
    def forward(self, inputs, seq_len=None, init_state=None, ori_state=False, res_mode="all"):
        """
...
class TextEncoder(nn.Module):
    ...
    def forward(self, inputs, seq_lens):
        ...
        if self.dataset == "eurlex":
            ...
            topk_text_outputs = torch.cat(topk_text_outputs, 1)
